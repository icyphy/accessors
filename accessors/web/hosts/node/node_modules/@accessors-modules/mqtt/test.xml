...
<entity name="test" class="ptolemy.actor.TypedCompositeActor">
    ...
    <property name="_vergilZoomFactor" class="ptolemy.data.expr.ExpertParameter" value="1.2468687176860926">
    </property>
    <property name="_vergilCenter" class="ptolemy.data.expr.ExpertParameter" value="{282.7871039511479, 192.9395483607253}">
    </property>
    ...
    <link port="MQTTPublisher.toPublish" relation="relation3"/>
    ...
    <link port="JavaScript2.in" relation="relation"/>
    <link port="JavaScript2.out" relation="relation3"/>
