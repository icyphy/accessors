exports.setup = function () {
    ...
    TextDisplayServerReceived.setParameter('title', "TextDisplay");
    ...
    TextDisplayClientReceived.setParameter('title', "TextDisplay");
    ...
    this.connect(TextDisplayServerReceived, 'output', JavaScriptPlusOne, 'input');
};
