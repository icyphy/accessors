exports.setup = function () {
    ...
    SerialPort.setParameter('receiveType', "number");
    SerialPort.setParameter('sendType', "number");
    SerialPort.setParameter('baudRate', 9600);

    // Start: TrainableTest: ptolemy/cg/adapter/generic/accessor/adapters/org/terraswarm/accessor/JSAccessor.java
    var TrainableTest = this.instantiate('TrainableTest', 'test/TrainableTest.js');
    TrainableTest.setParameter('correctValues', [0,1,2,3]);
    ...
    TrainableTest2.setParameter('correctValues', [0,1,2,3,4]);
    TrainableTest2.setParameter('trainingMode', false);
    TrainableTest2.setParameter('tolerance', 1.0E-9);

    // Connections: SerialLoopbackNumber: ptolemy/cg/adapter/generic/accessor/adapters/ptolemy/actor/TypedCompositeActor.java
