exports.setup = function () {
    ...
    //  To run the code, run: 
    //  (cd $PTII/org/terraswarm/accessor/accessors/web/net/test/auto; @node@ ../../../node_modules/@accessors-hosts/node/nodeHostInvoke.js  net/test/auto/TestRESTPost)
    ...
    //  $PTII/bin/capecode $PTII/./ptolemy/actor/lib/jjs/modules/httpClient/test/auto/TestRESTPost.xml
    ...
    var String = this.instantiateFromCode('String', unescape('/**%20Generate%20a%20string.%0A%20*%0A%20*%20%20@accessor%20String%0A%20*%20%20@input%20trigger%20When%20an%20input%20is%20received%2C%20output%20the%20string.%0A%20*%20%20@output%20output%20The%20string.%0A%20*%20%20@author%20Elizabeth%20Osyk%0A%20*%20%20@version%20%24%24Id%3A%20TestRESTPost.xml%2076897%202017-09-23%2012%3A51%3A09Z%20cxh%20%24%24%0A%20*/%0Aexports.setup%20%3D%20function%28%29%20%7B%0A%20%20%20%20this.input%28%27trigger%27%29%3B%0A%20%20%20%20this.output%28%27output%27%29%3B%0A%7D%3B%0A%0Aexports.initialize%20%3D%20function%28%29%20%7B%0A%20%20%20%20var%20self%20%3D%20this%3B%0A%20%20%20%20this.addInputHandler%28%27trigger%27%2C%20function%28%29%20%7B%0A%20%20%20%20%20%20%20var%20data%20%3D%20%22test%22%3B%0A%09%20%20%20self.send%28%27output%27%2C%20data%29%3B%0A%20%20%20%20%7D%29%3B%0A%7D%0A'));
    ...
    // FIXME: See instantiate() in accessors/web/hosts/common/commonHost.js
    // We probably need to do something with the bindings.
    var JSONStringified = this.instantiateFromCode('JSONStringified', unescape('/**%20Output%20stringified%20JSON.%0A%20*%0A%20*%20%20@accessor%20JSON%0A%20*%20%20@input%20trigger%20When%20an%20input%20is%20received%2C%20output%20stringified%20JSON.%0A%20*%20%20@output%20output%20Stringified%20JSON.%0A%20*%20%20@author%20Elizabeth%20Osyk%0A%20*%20%20@version%20%24%24Id%3A%20TestRESTPost.xml%2076897%202017-09-23%2012%3A51%3A09Z%20cxh%20%24%24%0A%20*/%0Aexports.setup%20%3D%20function%28%29%20%7B%0A%20%20%20%20this.input%28%27trigger%27%29%3B%0A%20%20%20%20this.output%28%27output%27%29%3B%0A%7D%3B%0A%0Aexports.initialize%20%3D%20function%28%29%20%7B%0A%20%20%20%20var%20self%20%3D%20this%3B%0A%20%20%20%20this.addInputHandler%28%27trigger%27%2C%20function%28%29%20%7B%0A%20%20%20%20%20%20%20var%20data%20%3D%20%7B%27test%27%20%3A%20%27this%20is%20JSON%20test%27%7D%3B%0A%09%20%20%20self.send%28%27output%27%2C%20JSON.stringify%28data%29%29%3B%0A%20%20%20%20%7D%29%3B%0A%7D%0A'));
