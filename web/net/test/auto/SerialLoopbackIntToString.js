exports.setup = function () {
    ...
    TrainableTest2.setParameter('correctValues', [65,66,67,68,69]);
    ...
    this.connect(JavaScriptTrueToken, 'output', And, 'input2');
    this.connect(TrainableTest2, 'output', And, 'input3');
};
