...
//These components won't display correct icons without these imports,
    ...
    ReactDOM.render(
        (
          ...
          <link rel="stylesheet" href={cordova.file.applicationDirectory + "www/lib/nucleo-icons.css"}/>
                ...
                <img src={cordova.file.applicationDirectory + "www/food/burger.jpeg"} alt="Tasty Hamburger" height="200" width="301"
